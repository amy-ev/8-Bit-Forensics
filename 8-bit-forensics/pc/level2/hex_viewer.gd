...
@onready var search_window = preload("res://pc/level2/search.tscn")
@onready var select_window = preload("res://pc/level2/select.tscn")
...
func _on_load_pressed() -> void:
	if !search_open && !select_open && !load_file_open:
		load_file_open = true
		add_child(load("res://pc/file_dialog/load_file.tscn").instantiate())
