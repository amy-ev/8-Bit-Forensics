...
@onready var client_scene = preload("res://pc/file_dialog/client.tscn")
@onready var files = preload("res://pc/file_dialog/file.tscn")
@onready var metadata_labels = preload("res://pc/level3/metadata_label.tscn")
	...
	if !selected_file.is_empty():
		...
		if parent.name == "metadata_window":
			...
			if !Global.first_image_opened:
				...
				dialogue.load_dialogue("res://dialogue/json_files/dialogue.json", "m2.0")
			...
			if !Global.first_file_opened && selected_file == "SD-image-file.001":
				...
				pc.add_child(dialogue)
				dialogue.load_dialogue("res://dialogue/json_files/dialogue.json", "h2.0")
