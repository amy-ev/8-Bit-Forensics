...
func menu_popup(id):
	if id == 0:
		if !Global.file_created: 
			screen.add_child(preload("res://evidence/select_source.tscn").instantiate())
		
func _on_file_created():
	var tree = $evidence_tree
		#TODO: change to match the file contents of the sd card
...
func _on_evidence_tree_item_selected() -> void:
	...
	if selected == "1GB [FAT16]":
		...
		f_1.set_text(0,"06404")
		f_2.set_text(0,"12804")
		f_3.set_text(0,"19204")
		f_4.set_text(0,"25604")
		f_5.set_text(0,"32004")
		f_6.set_text(0,"38404")
		f_7.set_text(0,"44804")
		f_8.set_text(0,"51204")
		f_9.set_text(0,"57604")
